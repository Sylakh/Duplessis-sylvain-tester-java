...
public class ParkingDataBaseIT {
	...
	public void testParkingLotExit() {
		...
		Date dateInTime = ticketFromDataBase.getInTime();

		Calendar calendar = Calendar.getInstance();
		// calendar.setTime(dateInTime);
		calendar.set(Calendar.HOUR_OF_DAY, dateInTime.getHours() - 1);
		// dateInTime = calendar.getTime();
		ticketFromDataBase.setInTime(calendar.getTime());
		...
		assertEquals(1.5, ticketFromDataBase.getPrice());
		// assertEquals(ticketFromDataBase.getInTime(),
		// ticketFromDataBase.getOutTime());
		assertNotEquals(null, ticketFromDataBase.getOutTime());
	}
	/**
	 * @Test public void testParkingLotExitRecurringUser() {
	 * 
	 *       }
	 */
}
